...
ActiveRecord::Schema.define(version: 20150722130851) do
  ...
  create_table "task_names", force: :cascade do |t|
    t.string   "name_of_task", limit: 255
  ...
  add_index "task_names", ["task_id"], name: "index_task_names_on_task_id", using: :btree
